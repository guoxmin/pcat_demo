...
function getWidgetTemplate(id, file) {
    ...
    if (namespace == project) {
        ...
        var version = getProjectVersion(namespace);
         ...
         // 解析跨系统资源依赖表路径
        var mapPath = path.resolve(outputPath,media,"map",namespace,version,"map.json");
        ...
        // 读取跨系统模板
        var templatePath = path.resolve(outputPath,media,"template","./"+uri);
